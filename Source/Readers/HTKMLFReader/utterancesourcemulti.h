...
class minibatchutterancesourcemulti : public minibatchsource
{
    ...
    const bool truncated;                    //false -> trauncated utterance or not within minibatch
    size_t maxUtteranceLength;                  //maximum utterance length in non-frame and non-truncated mode
